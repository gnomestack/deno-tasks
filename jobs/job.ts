        ...
        case 1:
            {
                ...
                if (typeof arguments[0] !== "string") {
                    throw new ArgumentException("id", "Expected string for argument 'id' or object for argument 'job'");
                }
            }
            break;
        ...
        case 2:
            {
                if (Array.isArray(arguments[1])) {
                    ...
                    throw new ArgumentException("action", "Expected function for argument 'action'");
                }
            }
            break;
        ...
        case 3:
            {
                if (!Array.isArray(arguments[2])) {
                    throw new ArgumentException("deps", "Expected array for argument 'deps'");
                }

                if (typeof arguments[1] !== "string") {
                    throw new ArgumentException("name", "Expected string for argument 'name'");
                }
