...
import { fs, env, path, homeConfigDir, secretGenerator, KdbxGroup, ProtectedValue, Kdbx, Credentials, Consts } from "../deps.ts";
...
export class KpDatabase {
    ...
    static async create(file: string, creds: Credentials, name?: string): Promise<KpDatabase> {
